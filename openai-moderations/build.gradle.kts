...
android { namespace = "io.github.androidpoet.openai.moderations"; compileSdk = Configuration.COMPILE_SDK; defaultConfig { minSdk = Configuration.MIN_SDK } }
mavenPublishing { coordinates(Configuration.GROUP, "openai-moderations", Configuration.VERSION) }
