...
android { namespace = "io.github.androidpoet.openai.batches"; compileSdk = Configuration.COMPILE_SDK; defaultConfig { minSdk = Configuration.MIN_SDK } }
mavenPublishing { coordinates(Configuration.GROUP, "openai-batches", Configuration.VERSION) }
