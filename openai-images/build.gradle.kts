...
android { namespace = "io.github.androidpoet.openai.images"; compileSdk = Configuration.COMPILE_SDK; defaultConfig { minSdk = Configuration.MIN_SDK } }
mavenPublishing { coordinates(Configuration.GROUP, "openai-images", Configuration.VERSION) }
