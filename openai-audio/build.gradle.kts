...
android { namespace = "io.github.androidpoet.openai.audio"; compileSdk = Configuration.COMPILE_SDK; defaultConfig { minSdk = Configuration.MIN_SDK } }
mavenPublishing { coordinates(Configuration.GROUP, "openai-audio", Configuration.VERSION) }
