...
android { namespace = "io.github.androidpoet.openai.uploads"; compileSdk = Configuration.COMPILE_SDK; defaultConfig { minSdk = Configuration.MIN_SDK } }
mavenPublishing { coordinates(Configuration.GROUP, "openai-uploads", Configuration.VERSION) }
