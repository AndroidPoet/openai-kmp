...
android { namespace = "io.github.androidpoet.openai.vectorstores"; compileSdk = Configuration.COMPILE_SDK; defaultConfig { minSdk = Configuration.MIN_SDK } }
mavenPublishing { coordinates(Configuration.GROUP, "openai-vectorstores", Configuration.VERSION) }
